...
API Calls - This folder contains the python code to extract House Listing, Restuarant and Bars data in Arlington, VA
Inputs - Consists of 4 Input data files filtered based on the distance
Modules - The folder consists of 4 python files to get the DSS Application up and running 
	...
	d)Flaskapp.py - Flask Framework which connects all the HTML webpage d)static - Contains a static image to be displayed in the UI e) Templates - consists of 3 HTML Webapges
...
Step 3 : Go to the Local Sever location displayed in the output by clicking on it (OR) type in the following address on any browser (http://127.0.0.1:5000/) 
...
Step 4 : Go to the Local Sever location displayed in the output by clicking on it (OR) type in the following address on any browser (http://127.0.0.1:5000/) 
