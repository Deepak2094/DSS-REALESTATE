...
def format_Listings(Listings_dict):
    ...
    for i in range(1, 7):
        ...
        variable_dict[f"Rank{i}_Restaurant"] = Listings_dict["Top_5_Rated_restaurants"][i].split(';')[0]
        variable_dict[f"Rank{i}_Bars"] = Listings_dict["Top_5_Rated_bars"][i].split(';')[0]
