        ...
        for k, v in Data.items():
            if k == "properties":
                ...
                for i in range(len(v)):
                    ...
                    if "agents" in Data["properties"][i].keys():
                        agent_name.append(Data["properties"][i]["agents"][0]["name"])
                    else:
                        agent_name.append("NA")

                    if "office" in Data["properties"][i].keys():
                        agent_office.append(Data["properties"][i]["office"]["name"])
                    else:
                        agent_office.append("NA")
...
Data_Dictionary["agent_name"] = agent_name
Data_Dictionary["agent_office"] = agent_office
