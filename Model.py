...
# Environmental Features dictionary - test stand in for dict generated by interface responses
# =============================================================================
# Environmental_Features = {	"Housebudget":"1VeryImportant",
# 							"HouseSize":"1Notimportantatall",
# 							"neighbourhoodfactors":"5VeryImportant",
...
# 							"Restaurants":"1Notimportantatall",
# 							"Bars":"5VeryImportant" }
# =============================================================================
...
def return_unpacked_weights(weights):
    ...
    for key in unpacked_weights:
        if key in field_name_xwalk.keys():
            unpacked_weights[field_name_xwalk[key]] = unpacked_weights.pop(key) 
...
def create_ranked_data(df, Environmental_Features):
    ...
    high_vals = ["SchoolRating","Mean_Rating_restaurants","Mean_Rating_bars"] # fields where high vals are important
